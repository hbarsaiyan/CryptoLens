...
export const InfiniteMovingCards = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        'scroller relative z-20 mx-auto w-full max-w-[320px] md:max-w-4xl lg:max-w-5xl overflow-hidden',
        className
      )}
    >
      {holdings.length > 0 ? (
      ...
      >
        {holdings.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-400 px-8 py-6 md:w-[350px]"
            style={{
              background:
